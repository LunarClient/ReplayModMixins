...
public class GuiHandlerReplayMixin_v1_19 {
    ...
    public void ichor$ensureReplayStopped(Screen guiScreen, CallbackInfo ci) {
        if (!((guiScreen instanceof ScreenInjectorBridge && ((ScreenInjectorBridge) guiScreen).getCustomScreen() instanceof MainMenuBaseLCUI) || guiScreen instanceof JoinMultiplayerScreen)) {
            ci.cancel();
        }
    }
}
