package com.moonsworth.lunar.replaymod.v1_21_11.link;
...
import com.moonsworth.lunar.replaymod.v1_21_11.mixin.GuiRecordingControlsAccessor;
...
public class ReplayModGuiLink_Impl extends EventRegistrations implements ReplayModLink {
    ...
    public ReplayModGuiLink_Impl() {
        EventBus.getBus().register(EventModUpdate.class, (e) -> {
            ...
            if (e.isNewState()) {
                ...
                ReplayModRecording.instance.getConnectionEventHandler()
                        .getPacketListener()
                        .addMarker(MarkerProcessor.MARKER_NAME_END_CUT);
                ...
                ((GuiRecordingControlsAccessor) ReplayModRecording.instance.getConnectionEventHandler().guiControls).bridge$updateState();
            } else {
                ...
                if (!connectionEventHandler.guiControls.paused) {
                    connectionEventHandler.getPacketListener()
                            .addMarker(MarkerProcessor.MARKER_NAME_START_CUT, timestamp);
                }
        ...
        on(ReplayOpenedCallback.EVENT, replayHandler -> {
            UUID uuid = Ref.mc().bridge$getSession().bridge$getId();
    ...
    public boolean isRecording() {
        return ReplayModRecording.instance.getConnectionEventHandler()
                .getPacketListener() != null && !isRecordingStopped();
    }
    ...
    public ResourceLocationBridge getReplayModTexture() {
        return (ResourceLocationBridge) (Object) ReplayMod.TEXTURE;
    }
    ...
    public void handleAssetPacket(Any packet) {
        ...
        ReplayModRecording.instance.getConnectionEventHandler()
                .getPacketListener()
                .save(new ReplayModScuffedPacketWrapped(packet));
    }
    ...
    public Set<KeyBindingBridge> getKeyBindings() {
        return (Set<KeyBindingBridge>) (Object) ReplayMod.instance.getKeyBindingRegistry()
                .getBindings()
                .values()
                .stream()
                .map(b -> b.keyBinding)
    ...
    public void stopRecording() {
        ...
        ((GuiRecordingControlsAccessor) guiControls).bridge$updateState();
    }
    ...
    public void pauseRecording() {
        ...
        ReplayModRecording.instance.getConnectionEventHandler()
                .getPacketListener()
                .addMarker(MarkerProcessor.MARKER_NAME_START_CUT);
