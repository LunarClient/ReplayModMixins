package com.moonsworth.lunar.replaymod.v1_21_11.metamixin;
...
public class ReplayModNonMMLauncherMixin_v1_20 {
    ...
    public List<String> getMixins() {
        try {
            if (ichor$hasClass("com.chocohead.mm.Plugin")) {
    ...
    private static boolean ichor$hasClass(String name) throws IOException {
