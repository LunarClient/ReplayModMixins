...
public abstract class AbstractGuiScreenMixin_v1_20<T> {
    ...
    @Shadow public abstract Screen toMinecraft();
            ...
            switch (this.background) {
                ...
                case DIRT:
                    if (!Lunar.getClient().getMods().getReplayMod().getLunarUi().get()) {
                        ((ScreenAccessor_v1_20) this.toMinecraft()).bridge$renderMenuBackground(bottom.getContext());
                        break;
                    }
                case DEFAULT:
                    if (Lunar.getClient().getMods().getReplayMod().getLunarUi().get()) {
                        ...
                        this.toMinecraft().renderBackground(bottom.getContext(), renderInfo.mouseX, renderInfo.mouseY, renderInfo.partialTick);
                        break;
                    }
                case TRANSPARENT:
                    int top = -1072689136;
