...
//                .poseStack((PoseStackBridge) bottom.getContext().pose())
...
//                        this.wrapped.renderMenuBackground(bottom.getContext());
//                        break;
//                    }
//                case DEFAULT:
//                    if (Lunar.getClient().getMods().getReplayMod().getLunarUi().get()) {
...
//                        }
//                    } else {
//                        this.wrapped.renderBackground(bottom.getContext(), renderInfo.mouseX, renderInfo.mouseY, renderInfo.partialTick);
//                        break;
//                    }
//                case TRANSPARENT:
//                    int top = -1072689136;
